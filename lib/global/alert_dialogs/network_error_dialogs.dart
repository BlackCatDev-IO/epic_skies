...
// Future<void> showNoConnectionDialog({required BuildContext? context, String? content, String? title}) async {
//   const content =
//       'Epic Skies needs an internet connection to pull weather data';
//   const goToSettings = MyTextWidget(
//     text: 'Go to network settings',
...
// Future<void> showAndroidDialog({required BuildContext context} String title, String content, }) {
//   return showDialog(
//       barrierDismissible: true,
//       context: context,
//       builder: (context) => AlertDialog(
