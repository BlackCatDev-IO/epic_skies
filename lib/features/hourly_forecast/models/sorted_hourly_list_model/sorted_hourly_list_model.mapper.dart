...
class SortedHourlyListMapper extends ClassMapperBase<SortedHourlyList> {
  ...
  static List<HourlyForecastModel> _$next24Hours(SortedHourlyList v) =>
      v.next24Hours;
  static const Field<SortedHourlyList, List<HourlyForecastModel>>
      _f$next24Hours =
      Field('next24Hours', _$next24Hours, opt: true, def: const []);
  static List<HourlyForecastModel> _$day1(SortedHourlyList v) => v.day1;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day1 =
      Field('day1', _$day1, opt: true, def: const []);
  static List<HourlyForecastModel> _$day2(SortedHourlyList v) => v.day2;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day2 =
      Field('day2', _$day2, opt: true, def: const []);
  static List<HourlyForecastModel> _$day3(SortedHourlyList v) => v.day3;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day3 =
      Field('day3', _$day3, opt: true, def: const []);
  static List<HourlyForecastModel> _$day4(SortedHourlyList v) => v.day4;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day4 =
      Field('day4', _$day4, opt: true, def: const []);
  static List<HourlyForecastModel> _$day5(SortedHourlyList v) => v.day5;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day5 =
      Field('day5', _$day5, opt: true, def: const []);
  static List<HourlyForecastModel> _$day6(SortedHourlyList v) => v.day6;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day6 =
      Field('day6', _$day6, opt: true, def: const []);
  static List<HourlyForecastModel> _$day7(SortedHourlyList v) => v.day7;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day7 =
      Field('day7', _$day7, opt: true, def: const []);
  static List<HourlyForecastModel> _$day8(SortedHourlyList v) => v.day8;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day8 =
      Field('day8', _$day8, opt: true, def: const []);
  static List<HourlyForecastModel> _$day9(SortedHourlyList v) => v.day9;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day9 =
      Field('day9', _$day9, opt: true, def: const []);
  static List<HourlyForecastModel> _$day10(SortedHourlyList v) => v.day10;
  static const Field<SortedHourlyList, List<HourlyForecastModel>> _f$day10 =
